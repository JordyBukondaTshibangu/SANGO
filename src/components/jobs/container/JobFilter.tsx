    ...
    return (
        <div className='w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-5'>
            ...
            <div className="flex gap-4 self-end">
                <Button className='bg-graySecond w-32 lg:w-48 h-12 lg:h-14 rounded-lg cursor-pointer flex justify-center items-center gap-4 text-xl text-white' onClick={handleDisplayFilter}>

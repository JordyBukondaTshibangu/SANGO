...
const JobSideInfo: React.FC<JobSideInfoProps> = ({
  ...
  return (
    <div className="lg:w-[68%] flex flex-col gap-10 -order-1 lg:order-1">
      <div className="flex flex-col gap-20 md:gap-0 md:flex-row border border-solid border-grayThird dark:border-darkHeader px-5 py-10 rounded-lg">
        <div className="flex-1 flex flex-col md:items-center gap-4  lg:border-r-2 border-solid px-3">
          <h4 className="text-lg font-medium">Salary (USD)</h4>
          <h5 className="text-success text-lg md:text-center">{salary}</h5>
          <p>Yearly salary</p>
        </div>
        <div className="flex-1 flex flex-col md:items-center gap-4">
          <MapOutlinedIcon className="text-4xl" />
          <h5>Job Location</h5>
          <p>{location}</p>
        </div>
      </div>
      <div className="flex flex-col gap-8 border border-solid border-grayThird dark:border-darkHeader px-10 py-10 rounded-lg">
        <h4 className="text-xl font-medium">Job Overview</h4>
        <div className="flex gap-20 md:gap-8 flex-wrap">
      ...
      <div className="flex flex-col gap-8 border border-solid border-grayThird dark:border-darkHeader p-10 rounded-lg">
        <h4 className="text-xl font-medium">Share this job:</h4>
        <div className="flex gap-5">
          <div className="flex gap-2 hover: bg-white  dark:bg-darkHeader px-3 py-2 cursor-pointer rounded-md">

  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2 xl:gap-20">
        ...
        <div
          className="flex-1 rounded-xl flex items-center justify-center gap-2 xl:gap-4 cursor-pointer px-2 xl:px-5 py-2 bg-dark xl:bg-inherit xl:hover:bg-dark"
      ...
      {openCommentPannel && (
        <div className="border-t border-solid py-10 flex flex-col gap-2">

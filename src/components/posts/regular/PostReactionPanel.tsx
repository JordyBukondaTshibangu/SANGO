  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-2 xl:gap-20">
        <div className="flex-1 rounded-xl flex items-center justify-center gap-2 xl:gap-4 cursor-pointer px-2 xl:px-5 py-2 bg-light  dark:bg-dark xl:bg-inherit xl:dark:hover:bg-light dark:bg-dark">
          <span className="text-sm xl:text-lg min-w-max">{likes} Likes </span>
          <ThumbUpOffAltIcon className="text-sm xl:text-2xl leading-none" />
        </div>
        <div
          className="flex-1 rounded-xl flex items-center justify-center gap-2 xl:gap-4 cursor-pointer px-2 xl:px-5 py-2 bg-light  dark:bg-dark xl:bg-inherit xl:dark:hover:bg-light dark:bg-dark"
        ...
        <div className="flex-1 rounded-xl flex items-end justify-center gap-2 xl:gap-4 cursor-pointer px-2 xl:px-5 py-2 bg-light  dark:bg-dark xl:bg-inherit xl:dark:hover:bg-light dark:bg-dark">

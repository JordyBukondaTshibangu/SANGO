...
const ArticleHero = () => {
  ...
  return (
    <div className="relative bg-contain bg-[url('https://images.unsplash.com/photo-1540575467063-178a50c2df87?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] min-h-[550px] rounded-xl flex flex-col  gap-5 md:gap-10 p-5 lg:p-10">

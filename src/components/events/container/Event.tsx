          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col lg:flex-row justify-between gap-5">
                  <div className="flex gap-6">
                    <span className='cursor-pointer flex items-center justify-center bg-primary rounded-3xl text-white text-sm lg:px-5 lg:py-3 px-4 py-2'>View Agenda</span>
                    <span className='cursor-pointer flex items-center justify-center bg-grayFirst rounded-3xl text-white text-sm lg:px-5 lg:py-3 px-4 py-2'>Unenroll</span>
                    <span className='cursor-pointer flex items-center justify-center bg-darkHeader rounded-3xl text-white text-sm lg:px-5 lg:py-3 px-4 py-2'>Personalize</span>
                </div>
          ...
          <div className='flex flex-col lg:flex-row justify-between gap-20'>
            <div className="flex-1 flex flex-col gap-10">
                  ...
                  <div className="flex flex-col gap-20">
                      <div className="flex flex-col gap-6">
                          <div className="bg-darkHeader w-fll min-w-96 h-72 rounded-md"></div>
            ...
            <div className="flex-1 flex flex-col gap-4 bg-darkHeader px-5 py-10 rounded-xl">
                <h4 className="text-xl font-medium">Photo Gallery</h4>
                  <div className="grid grid-cols-3 md:grid-cols-4 gap-2">
                      {gallery.map((pic: string, index: number) => <Image key={index}  src={pic} width={180} height={100} alt='' className='rounded-2xl hover:scale-110 transition ease-in-out duration-300 cursor-pointer' />)}
                </div>  
            </div>
          </div>
    </div>

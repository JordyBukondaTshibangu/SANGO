...
const ProfileExperience:React.FC<ProfileExperienceProps> = ({experiences, other}) => {
  return (
    <div className='w-full bg-darkHeader px-5 py-10 flex flex-col gap-8'>
      ...
      <div className='w-full flex flex-col gap-4 '>
        {
           experiences.map((experience:UserExperienceT, index: number) => <Experince key={index} experience={experience} />)
        }
        </div>
    </div>
  )

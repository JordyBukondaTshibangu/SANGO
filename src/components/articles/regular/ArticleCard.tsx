...
const ArticleCard: React.FC<ArticleCardProps> = ({ article }) => {
  return (
    <Link
      ...
      className="flex-1 flex flex-col bg-darkHeader lg:min-w-[438px] max-w-[518px] h-[494px] rounded-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all"
    >
      <div className="w-full  bg-cloudGray h-1/2 rounded-lg">
        <Image
          ...
          height={200}
          alt={article.title}
          className="overflow-hidden object-cover w-full h-full rounded-tr-lg rounded-tl-lg"
        />
      </div>

...
const ChatPreview: React.FC<ChatPreviewProps> = ({ chat }) => {
  ...
  return (
    <div className="cursor-pointer w-full flex gap-5 items-center lg:px-5 py-3 border-grayFour dark:border-darkHeader lg:border-dark bg-light dark:bg-dark rounded-lg">

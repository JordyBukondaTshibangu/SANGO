  ...
  return (
    <div className='flex flex-col gap-20 xl:px-32'>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <p>Sango's mission is to connect the world’s professionals to allow them to be more productive and successful. Central to this mission is our commitment to be transparent about the data we collect about you, how it is used and with  whom it is shared.
        </p>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <ol className='px-5 flex flex-col gap-5'>
          <li className='text-[16px]'>1.<span className="text-white px-5 font-medium text-[16px]">Data We Collect</span></li>
          <li className='text-[16px]'>2.<span className="text-white px-5 font-medium text-[16px]">How We Use Your Data</span></li>
          <li className='text-[16px]'>3.<span className="text-white px-5 font-medium text-[16px]">How We Share Information</span></li>
        </ol>
      </div>
      <div className='flex flex-col gap-6'>
      ...
      <div className='flex flex-col gap-6'>
        ...
        <div className='flex flex-col gap-4 px-10'>
          ...
          <p>We will contact you through email, mobile phone, notices posted on our websites or apps, messages to your Sango inbox, and other ways through our Services, including text messages and push notifications. We will send you messages about the availability of our Services, security, or other service-related issues. We also send messages about how to use our Services, network updates, reminders, job suggestions and promotional messages from us and our partners. You may change your communication preferences at any time. Please be aware that you cannot opt out of receiving service messages from us, including security and legal notices.
          </p>
        </div>
      </div>
      <div className='flex flex-col gap-6'>
        ...
        <div className='flex flex-col gap-4 px-10'>
          <h5 className='text-lg font-light italic'>Registration</h5>
          <p>It is possible that we will need to disclose information about you when required by law, subpoena, or other legal process or if we have a good faith belief that disclosure is reasonably necessary to (1) investigate, prevent or take action regarding suspected or actual illegal activities or to assist government enforcement agencies; (2) enforce our agreements with you; (3) investigate and defend ourselves against any third-party claims or allegations; (4) protect the security or integrity of our Services (such as by sharing with companies facing similar threats); or (5) exercise or protect the rights and safety of Sango, our Members, personnel or others. We attempt to notify Members about legal demands for their personal data when appropriate in our judgment, unless prohibited by law or court order or when the request is an emergency. We may dispute such demands when we believe, in our discretion, that the requests are overbroad, vague or lack proper authority, but we do not promise to challenge every demand</p>
        </div>
      </div>
    </div>
  )

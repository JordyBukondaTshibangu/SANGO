    ...
    <div className='flex flex-col gap-48 xl:px-10'>
      ...
      <div className='flex flex-col lg:flex-row'>
        <div className='flex-1 flex flex-col gap-6 lg:px-5 lg:w-3/5'>
          ...
          <p className='w-3/4'>Welcome to Sango, the world's largest professional network with more than
        ...
        <div className='flex-1 px-5 p-10 bg-darkHeader text-white rounded-lg shadow-md'>
          ...
          >
            <div className="flex items-center gap-5 !text-white">
              <TextField id="outlined-basic" label="First name" variant="outlined"  className='w-full text-white'/>
              <TextField id="outlined-basic" label="Last name" variant="outlined"  className='w-full text-white'/>
            </div>
            <TextField id="outlined-basic" label="Email address" variant="outlined" className='w-full text-white'/>
            <TextField

...
const LoadingJob = () => {
  return (
    <div
      role="status"
      className="w-full mx-auto animate-pulse flex flex-col lg:flex-row gap-32"
    >
      <div className="w-full flex flex-col gap-10">
        <div className="w-full flex gap-5 items-center">
          <div className="w-28 h-20 lg:w-36 lg:h-36 bg-grayThird rounded-full dark:bg-darkHeader"></div>

  ...
  return (
    ...
    >
      <div className="w-full flex flex-col lg:flex-row justify-between lg:items-center lg:gap-20">
        <div className="h-14 bg-grayThird rounded-lg dark:bg-darkHeader w-1/2 mb-4"></div>
        <div className="h-14 bg-grayThird rounded-lg dark:bg-darkHeader w-full mb-4"></div>
        <div className="h-14 bg-grayThird rounded-lg dark:bg-darkHeader w-full mb-4"></div>
        <div className="h-14 bg-grayThird rounded-lg dark:bg-darkHeader w-1/2 mb-4"></div>
      </div>
      ...
      <div className="w-full flex gap-10 flex-wrap items-center">
        <div className="w-full md:w-[340px] lg:w-[300px] xl:w-[375px] flex h-64 rounded bg-grayThird dark:bg-darkHeader"></div>
        <div className="w-full md:w-[340px] lg:w-[300px] xl:w-[375px] flex h-64 rounded bg-grayThird dark:bg-darkHeader"></div>
        <div className="w-full md:w-[340px] lg:w-[300px] xl:w-[375px] flex h-64 rounded bg-grayThird dark:bg-darkHeader"></div>
        <div className="w-full md:w-[340px] lg:w-[300px] xl:w-[375px] flex h-64 rounded bg-grayThird dark:bg-darkHeader"></div>
        <div className="w-full md:w-[340px] lg:w-[300px] xl:w-[375px] flex h-64 rounded bg-grayThird dark:bg-darkHeader"></div>

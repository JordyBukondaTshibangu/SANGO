  ...
  return (
    ...
    >
      ...
      <div className="w-full flex gap-10 flex-wrap items-center">
        <div className="w-full md:w-[320px] lg:w-[280px] flex h-96 rounded bg-grayThird"></div>
        <div className="w-full md:w-[320px] lg:w-[290px] flex h-96 rounded bg-grayThird"></div>
        <div className="w-full md:w-[320px] lg:w-[290px] flex h-96 rounded bg-grayThird"></div>
        <div className="w-full md:w-[320px] lg:w-[290px] flex h-96 rounded bg-grayThird"></div>
        <div className="w-full md:w-[320px] lg:w-[290px] flex h-96 rounded bg-grayThird"></div>
        <div className="w-full md:w-[320px] lg:w-[290px] flex h-96 rounded bg-grayThird"></div>
